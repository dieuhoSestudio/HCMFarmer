...
let users = [
  { id: 1, password: 'admin', username: 'admin', role: 'Admin', token: 'hfkahfihciwciwehc' }
];
...
const fakeBackend = () => {
  ...
  //============ Register Request =============*
  mockAdapt.onPost('/post-register').reply(function (config:any) {
  ...
  //============ Login Request =============*
  mockAdapt.onPost('/post-login').reply(function (config:any) {
